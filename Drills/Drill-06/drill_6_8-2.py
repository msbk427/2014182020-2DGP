...
size = 10
points = [(random. randint (-300, 300), random.randint(-300, 300)) for i in range(size)]
drill_6_8_1(points[0], points[1], points[2], points[3], points[4], points[5], points[6], points[7], points[8], points[9])
