...
def drill_6_8_1(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10):
    ...
    for i in range(0, 100, 2):
        t = i / 100
        cx = ((-(t+1) ** 3 + 2 * (t+1) ** 2 - t) * p1[0] + (3 * (t+1) ** 3 - 5 * (t+1) ** 2 + 2) * p2[0] + (
    ...
    for i in range(0, 100, 2):
        t = i / 100
        cx = ((-(t + 1) ** 3 + 2 * (t + 1) ** 2 - t) * p2[0] + (3 * (t + 1) ** 3 - 5 * (t + 1) ** 2 + 2) * p3[0] + (
                -3 * (t + 1) ** 3 + 4 * (t + 1) ** 2 + (t + 1)) * p4[0] + ((t + 1) ** 3 - (t + 1) ** 2) * p5[0]) / 2
    ...
    for i in range(0, 100, 2):
        t = i / 100
        cx = ((-(t + 1) ** 3 + 2 * (t + 1) ** 2 - t) * p3[0] + (3 * (t + 1) ** 3 - 5 * (t + 1) ** 2 + 2) * p4[0] + (
                -3 * (t + 1) ** 3 + 4 * (t + 1) ** 2 + (t + 1)) * p5[0] + ((t + 1) ** 3 - (t + 1) ** 2) * p6[0]) / 2
    ...
    for i in range(0, 100, 2):
        t = i / 100
        cx = ((-(t + 1) ** 3 + 2 * (t + 1) ** 2 - t) * p4[0] + (3 * (t + 1) ** 3 - 5 * (t + 1) ** 2 + 2) * p5[0] + (
                -3 * (t + 1) ** 3 + 4 * (t + 1) ** 2 + (t + 1)) * p6[0] + ((t + 1) ** 3 - (t + 1) ** 2) * p7[0]) / 2
    ...
    for i in range(0, 100, 2):
        t = i / 100
        cx = ((-(t + 1) ** 3 + 2 * (t + 1) ** 2 - t) * p5[0] + (3 * (t + 1) ** 3 - 5 * (t + 1) ** 2 + 2) * p6[0] + (
                -3 * (t + 1) ** 3 + 4 * (t + 1) ** 2 + (t + 1)) * p7[0] + ((t + 1) ** 3 - (t + 1) ** 2) * p8[0]) / 2
    ...
    for i in range(0, 100, 2):
        t = i / 100
        cx = ((-(t + 1) ** 3 + 2 * (t + 1) ** 2 - t) * p6[0] + (3 * (t + 1) ** 3 - 5 * (t + 1) ** 2 + 2) * p7[0] + (
                -3 * (t + 1) ** 3 + 4 * (t + 1) ** 2 + (t + 1)) * p8[0] + ((t + 1) ** 3 - (t + 1) ** 2) * p9[0]) / 2
    ...
    for i in range(0, 100, 2):
        t = i / 100
        cx = ((-(t + 1) ** 3 + 2 * (t + 1) ** 2 - t) * p7[0] + (3 * (t + 1) ** 3 - 5 * (t + 1) ** 2 + 2) * p8[0] + (
                -3 * (t + 1) ** 3 + 4 * (t + 1) ** 2 + (t + 1)) * p9[0] + ((t + 1) ** 3 - (t + 1) ** 2) * p10[0]) / 2
    ...
    for i in range(0, 100, 2):
        t = i / 100
        cx = ((-(t + 1) ** 3 + 2 * (t + 1) ** 2 - t) * p8[0] + (3 * (t + 1) ** 3 - 5 * (t + 1) ** 2 + 2) * p9[0] + (
                -3 * (t + 1) ** 3 + 4 * (t + 1) ** 2 + (t + 1)) * p10[0] + ((t + 1) ** 3 - (t + 1) ** 2) * p1[0]) / 2
    ...
    for i in range(0, 100, 2):
        t = i / 100
        cx = (((-t + 1) ** 3 + 2 * (t + 1) ** 2 - t) * p9[0] + (3 * (t + 1) ** 3 - 5 * (t + 1) ** 2 + 2) * p10[0] + (
                -3 * (t + 1) ** 3 + 4 * (t + 1) ** 2 + (t + 1)) * p1[0] + ((t + 1) ** 3 - (t + 1) ** 2) * p2[0]) / 2
...
direction = 1
size = 10
points1 = [random.randint(0, 500), random.randint(0, 500)]
points2 = [random.randint(0, 500), random.randint(0, 500)]
points3 = [random.randint(0, 500), random.randint(0, 500)]
points4 = [random.randint(0, 500), random.randint(0, 500)]
points5 = [random.randint(0, 500), random.randint(0, 500)]
points6 = [random.randint(0, 500), random.randint(0, 500)]
points7 = [random.randint(0, 500), random.randint(0, 500)]
points8 = [random.randint(0, 500), random.randint(0, 500)]
points9 = [random.randint(0, 500), random.randint(0, 500)]
points10 = [random.randint(0, 500), random.randint(0, 500)]
